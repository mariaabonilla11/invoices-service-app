...
ActiveRecord::Schema[7.2].define(version: 2025_11_06_040102) do
...
#   Unknown type 'SYS.AQ$_SUBSCRIBERS' for column 'subscribers'
  ...
  create_table "invoices", force: :cascade do |t|
    ...
    t.integer "amount", precision: 38, default: 0, null: false
    t.integer "state", precision: 38, default: 1, null: false
